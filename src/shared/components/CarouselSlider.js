...
class CarouselSlider extends Component {
     ...
     render() {
          return (
               <Carousel>
                    < Carousel.Item >
                         <img className="carouselImage" src="images/problem.jpg" alt="" />
                    ...
                    < Carousel.Item >
                         <img className="carouselImage" src="images/aerial.jpg" alt="" />
                         <Container className="carouselCaption">
                    ...
                    < Carousel.Item >
                         <img className="carouselImage" src="images/carouselHolder.jpg" alt="" />
                         <Container className="carouselCaption">
